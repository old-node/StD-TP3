/*======================================================================================
Fichier:		sqlConnect.h
Auteur:			Olivier Lemay Dostie & Simon Lagacé
Date:			22-11-2017
Description:	Classe qui sert de relais entre la bd et l'application du TP3
======================================================================================*/
...
// Permet de faire des opérations avec la base de donnée ThePainter3
class sqlConnect
{
private:
	//Variable SQL
	...
	vector<tblDessinCol> dessinElem;
	vector<tblTypeColorCol> typeColorElem;
	vector<tblTypeShapeCol> typeShapeElem;
...
/// Utilisateur
// Ajoute un utilisateur dans ThePainter3.
...
// Sélectionne un utilisateur existant
